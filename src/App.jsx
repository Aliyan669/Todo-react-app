      ...
      <header className="App-header">
        <div className='Main'>
         <Header />
            ...
            <Button Class="btn" onClick={valueAdd} btnName={"Add"} />
          <Button Class="btn" onClick={DeleteAll} btnName="Delete All" />
          <ul>
            {list.map((v) => {
              return <div>
                <li className='list' ><span key={v.id}>{v.txt}</span>
                <Button Class="btn" onClick={() => valueEdit(v.id)} btnName="Edit" />
                <Button Class="btn" onClick={() => valueDelete(v.id)} btnName="Delete" />
                </li>
              </div>
            })}
          </ul>
